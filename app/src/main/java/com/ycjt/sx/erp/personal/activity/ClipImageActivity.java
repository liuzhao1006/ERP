...
import com.ycjt.sx.widget.view.ClipViewLayout;
...
public class ClipImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popupwindow_clip_image);
    ...
    public void initView() {
        ...
        btnCancel = (FontTextView) findViewById(R.id.btn_cancel);
        btnOk = (FontTextView) findViewById(R.id.bt_ok);
        //设置点击事件监听器
