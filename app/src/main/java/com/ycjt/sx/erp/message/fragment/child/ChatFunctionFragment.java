...
public class ChatFunctionFragment extends KeyFragment implements View.OnClickListener {
    ...
    public void onActivityResult(int req, int res, Intent data) {
        LogUtils.i("int ~" + req + ",int ~ " + res + ",Intent ~ " + data);
        switch (req) {
            case CROP_PHOTO:
            ...
            case REQUEST_CODE_PICK_IMAGE:
                if (res == Activity.RESULT_OK) {
                    try {
                        if (data == null) {
                            Toast.makeText(mActivity, "我为空", Toast.LENGTH_SHORT).show();
                            return;
                        }
