...
import com.ycjt.sx.erp.workbench.activity.WorkBenchChartShopActivity;
 ...
 * GetOrderHead/99D7E378-0BE0-4703-B157-E88C100C5DF1/DEVICEID/04f12beb-d99d-43df-ac9a-3042957d6bda/2017/08
 */
@SuppressLint("ValidFragment")
public class WorkBenchPurchasingStatistics extends BaseFragment implements OnChartValueSelectedListener, ISimple {
    ...
    public void initViewSaved(View mRootView, Bundle savedInstanceState) {
        ...
        llWorkBenchChartMore.setOnClickListener(view -> {
            Intent i = new Intent(mActivity, WorkBenchChartShopActivity.class);
            startActivity(i);
        });
        //获取销售订单
        init(mRootView);
    ...
    private void setYearPopupWindow() {
        ...
        s1SPW = new SpinerPopWindow(getActivity(), year, 1);
    ...
    private void init(View view) {
        ...
        getHttpData();
        //初始化时 创建图表管理器
        manager = new PieChartManager(mActivity, mChart, "月采购统计");
