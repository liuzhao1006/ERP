package com.ycjt.sx.widget.chatkeymanager;
...
public class EmotionInputDetector {
    ...
    private FontTextView mVoiceText;
    ...
    private FontTextView mPopVoiceText;
    ...
    public EmotionInputDetector bindToVoiceText(FontTextView voiceText) {
    ...
    public EmotionInputDetector build() {
        ...
        final FontTextView mTextView = (FontTextView) view.findViewById(R.id.tv_recording_time);
        mPopVoiceText = (FontTextView) view.findViewById(R.id.tv_recording_text);
        //录音回调
