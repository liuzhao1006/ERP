package com.ycjt.sx.widget.recycleline.customrecycle;
...
public class CustomRecycleView extends FrameLayout {
    public static final String TAG = "CustomRecycleView";
    ...
    public static class EasyDataObserver extends AdapterDataObserver {
        ...
        public EasyDataObserver(CustomRecycleView recyclerView) {
